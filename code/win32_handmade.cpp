...
// on incorrect versions of specific libraries. In this case XInput and DSound.
// Normally I would'n do it, but right now I'm following the instructions.
...
internal void
Win32ProcessDigitalXInputButton(DWORD XInputButtonState,
